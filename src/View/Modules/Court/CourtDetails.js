...
//                             ))}
//                         </div>
//                         {publisherAttachments !== null && publisherAttachments.length !== 0 && (
//                             <Attachments attachments={publisherAttachments} name={`Publisher Attachments`}/>
//                         )}
//                         {workerAttachments !== null && workerAttachments.length !== 0 && (
//                             <Attachments attachments={workerAttachments} name={`Worker Attachments`}/>
//                         )}
//                         <Badge
//                             pill
//                             style={{
