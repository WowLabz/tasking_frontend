...
const AdvanceSearch = (props) => {
  ...
  const filteredStatus = Object.keys(MILESTONE_STATUS).map((key) => ({
    value: MILESTONE_STATUS[key],
    label: MILESTONE_STATUS[key],
  }));
  return (
    <>
          ...
          <Form>
            <Segment>
              ...
              <FormControl
                ...
                value={
                  searchCriteria.minimumCost ? searchCriteria.minimumCost : ""
                }
                onChange={(event) => {
                  const tempSearch = { ...searchCriteria };
              ...
              <FormControl
                ...
                value={
                  searchCriteria.maximumCost ? searchCriteria.maximumCost : ""
                }
                onChange={(event) => {
                  const tempSearch = { ...searchCriteria };
              ...
              <FormControl
                ...
                value={
                  searchCriteria.minimumDeadline
                    ? searchCriteria.minimumDeadline
                    : ""
                }
                onChange={(event) => {
              ...
              <FormControl
                ...
                placeholder="Minimum deadline for a milestone"
                value={
                  searchCriteria.maximumDeadline
                    ? searchCriteria.maximumDeadline
                    : ""
                }
                onChange={(event) => {
